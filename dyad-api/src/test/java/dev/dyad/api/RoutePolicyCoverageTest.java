...
import dev.dyad.api.security.RoutePolicy;
...
class RoutePolicyCoverageTest extends ApiTestBase {
    ...
    @Autowired private RoutePolicy policy;
    ...
    void everyApplicationRouteIsRegistered() {
        ...
        assertThat(unregistered)
                .as("routes missing from RoutePolicy; add an entry naming the scope that may call them")
                .isEmpty();
    }
