...
class Bm25Test {
    ...
    private static final Bm25.CorpusStats STATS =
            new Bm25.CorpusStats(1000, 10.0, Map.of("서울", 50L, "강남", 20L, "the", 900L));
    ...
    void shorterDocumentsScoreHigherForTheSameMatch() {
        ...
        double longDoc = Bm25.score(query, List.of("앨리스", "서울", "거주", "그리고", "여행", "취미", "커피", "독서",
                "영화", "음악", "요리", "운동"), STATS);
