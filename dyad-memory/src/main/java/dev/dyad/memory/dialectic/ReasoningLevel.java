...
public enum ReasoningLevel {
    MINIMAL(1, List.of(ToolRegistry.RECALL)),
    LOW(3, List.of(ToolRegistry.RECALL, ToolRegistry.SEARCH_MESSAGES)),
    MEDIUM(
            6,
            List.of(
                    ToolRegistry.RECALL,
                    ToolRegistry.SEARCH_MESSAGES,
                    ToolRegistry.GREP_MESSAGES,
                    ToolRegistry.MESSAGES_BY_DATE)),
    HIGH(
            10,
            List.of(
                    ToolRegistry.RECALL,
                    ...
                    ToolRegistry.GREP_MESSAGES,
                    ToolRegistry.MESSAGES_BY_DATE,
                    ToolRegistry.SEARCH_TEMPORAL,
                    ToolRegistry.REASONING_CHAIN)),
    MAX(
            16,
            List.of(
                    ToolRegistry.RECALL,
    ...
    public static ReasoningLevel fromWire(String wire) {
        ...
        throw new DyadException("bad_reasoning_level", "unknown reasoning level: " + wire);
    }
}
