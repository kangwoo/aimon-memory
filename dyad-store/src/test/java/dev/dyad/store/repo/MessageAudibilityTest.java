...
class MessageAudibilityTest extends StoreTestBase {
    ...
    void aRejoinedPeerKeepsWhatTheyHeardBefore() {
        ...
        assertThat(aliceSearches("era"))
                .containsExactlyInAnyOrder(
                        "era one: alice works at a bank", "era three: alice is back");
    }
    ...
    void replacingTheRosterClosesTheDepartedWindows() {
        ...
        sessionPeers.replace(
                WORKSPACE, "s1", List.of(SessionPeerRepository.Membership.of("carol")));
    ...
    void theSameWindowsGovernKeywordAndDateSearch() {
        ...
        assertThat(messages.searchText(WORKSPACE, "alice", "s1", "bank", 50))
