 ...
 */
@ConfigurationProperties(prefix = "aimon.memory.worker")
public record WorkerProperties(String workerId, int concurrency, int unitsPerPoll, int itemsPerUnit, Duration claimTtl,
        Duration minPollInterval, Duration maxPollInterval, int maxAttempts, Duration reconcilerInterval,
