...
class AnalyzerTest {
    ...
    void englishAnalyzerLowercasesAndKeepsStopWords() {
        try (EnglishTextAnalyzer analyzer = new EnglishTextAnalyzer()) {
            assertThat(analyzer.tokens("Alice works AT a Bank")).containsExactly("alice", "works", "at", "a", "bank");
        }
    }
    ...
    void bigramFallbackShredsCjkButKeepsLatinWords() {
        ...
        assertThat(analyzer.tokens("alice 서울강남 2024")).containsExactly("alice", "서울", "울강", "강남", "2024");
