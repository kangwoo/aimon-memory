...
public final class ResponseSchemaGuard {
    ...
    private static final Set<String> ALLOWED_TYPES = Set.of("object", "array", "string", "integer", "number",
            "boolean");
    private static final Set<String> ALLOWED_KEYWORDS = Set.of("type", "properties", "items", "required",
    ...
    private static MemoryException reject(String reason) {
        return new MemoryException("bad_response_format", "response_format rejected: " + reason);
    }
}
