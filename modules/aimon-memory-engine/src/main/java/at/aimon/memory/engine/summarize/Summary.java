...
public record Summary(String kind, String text, long coversThroughSeq, int tokenCount, Instant createdAt) {
    ...
    public Map<String, Object> toMap() {
        return Map.of("kind", kind, "text", text, "covers_through_seq", coversThroughSeq, "token_count", tokenCount,
                "created_at", createdAt.toString());
    }

    public static Summary fromMap(Map<String, Object> map) {
        return new Summary(String.valueOf(map.get("kind")), String.valueOf(map.get("text")),
