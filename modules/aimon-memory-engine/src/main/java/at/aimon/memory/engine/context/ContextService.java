...
public class ContextService {
    ...
    public ContextService(SessionRepository sessions, MessageRepository messages, SummarizerService summarizer) {
    ...
    public ContextResult context(String workspace, String sessionName, int tokenBudget) {
        ...
        Session session = sessions.find(workspace, sessionName)
    ...
    public String render(ContextResult context, String target, String perspective) {
        ...
        context.messages().forEach(m -> sb.append(m.peerName()).append(": ").append(m.content()).append('\n'));
