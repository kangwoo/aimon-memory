...
public final class Requests {
    ...
    public record CreateMessages(@NotEmpty @Size(max = 100) List<NewMessage> messages) {
    }
    ...
    public record ChatRequest(@NotBlank String question, @NotBlank String observer, @NotBlank String observed,
            String session, String reasoningLevel, List<ChatTurn> history, Map<String, Object> responseFormat) {
    }
