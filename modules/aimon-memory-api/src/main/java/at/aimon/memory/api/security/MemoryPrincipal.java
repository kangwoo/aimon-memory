 ...
 */
public record MemoryPrincipal(TokenScope scope, String workspace, String peer, String session,
        boolean allowMemberRead) {

    public static MemoryPrincipal admin() {
        return new MemoryPrincipal(TokenScope.ADMIN, null, null, null, false);
    }
