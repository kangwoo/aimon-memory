 ...
 */
public record SessionPeer(String workspaceName, String sessionName, String peerName, Boolean observeMe,
        Boolean observeOthers, Instant joinedAt, Instant leftAt) {
