...
public record Session(String name, String workspaceName, boolean isActive, Map<String, Object> metadata,
        Map<String, Object> configuration, Map<String, Object> internalMetadata, Instant createdAt) {
