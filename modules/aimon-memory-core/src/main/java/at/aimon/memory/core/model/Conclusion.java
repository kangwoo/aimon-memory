 ...
 */
public record Conclusion(String id, PairKey pair, String sessionName, String content, String contentNorm,
        String contentAnalyzed, String contentHash, ConclusionLevel level, Double confidence, List<String> sourceIds,
        List<Long> messageIds, int timesDerived, Instant lastReinforcedAt, Instant createdAt, Instant updatedAt,
        Instant expiresAt, Instant deletedAt, SyncState syncState) {
