...
public class ProvenanceService {
    ...
    public ProvenanceService(
            EntityRepository entities, ConclusionRepository conclusions, MessageRepository messages) {
     ...
     */
    public record ConclusionProvenance(
            Conclusion conclusion,
            List<Conclusion> premises,
    ...
    public ConclusionProvenance forConclusion(PairKey pair, Conclusion conclusion) {
        ...
        List<String> missing =
                conclusion.sourceIds().stream().filter(id -> !resolved.contains(id)).toList();
