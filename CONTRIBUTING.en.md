...
|---|---|:-:|---|
| `./gradlew checkAll` | Formatting, style, the BOM, the 278 tests that need no database, and the 21 contract cases | no | on every save |
| `./gradlew integrationTest` | The 290 Testcontainers tests | yes | before opening a PR |
