...
|---|---|:-:|---|
| `./gradlew checkAll` | Formatting, style, the BOM, the 282 tests that need no database, and the 21 contract cases | no | on every save |
| `./gradlew integrationTest` | The 303 Testcontainers tests | yes | before opening a PR |
