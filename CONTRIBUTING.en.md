...
|---|---|:-:|---|
| `./gradlew checkAll` | Formatting, style, the BOM, the 275 tests that need no database, and the 21 contract cases | no | on every save |
| `./gradlew integrationTest` | The 285 Testcontainers tests | yes | before opening a PR |
