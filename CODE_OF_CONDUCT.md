...
모욕적이거나 괴롭힘 또는 그 외 하지말아야 할 행동을 발견하면 GitHub 의 [남용 신고](https://github.com/contact/report-abuse) 를 통해 집행 책임이 있는 커뮤니티 리더에게 보고한다. 모든 불만사항은 신속하고 공정하게 검토되고 조사될 것이다.

현재는 이것이 유일한 신고 창구다. 프로젝트 전용 연락처 이메일은 두지 않았다 — 유지보수자가 한
명이라, 지켜지지 않는 주소를 적어 두는 것이 없는 것보다 나쁘기 때문이다.
