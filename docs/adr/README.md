...
| [0007](0007-aimon-core-boundary.md) | aimon-core 와의 경계는 `PeerMemory` 이고, 그것뿐이다 | accepted · 2026-09-04 | 이음매는 타입 하나. 테넌시는 이쪽, 에이전트는 저쪽. 덧붙임 세 개가 계약 스위트 배선, 그 뒤의 좌표 분리, 그리고 계약 계층이 어디서나 도는 데까지를 기록한다 |
...
긋는 문서이고, 세 개의 덧붙임이 그 뒤에 실제로 일어난 일을 담고 있다.
